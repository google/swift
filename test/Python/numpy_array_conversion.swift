...
NumpyArrayConversionTests.test("dtype-compatible") {
  ...
  expectTrue(Bool.isCompatibleNumpyScalarType(np.bool))
  expectTrue(Bool.isCompatibleNumpyScalarType(Python.bool))
  expectTrue(UInt8.isCompatibleNumpyScalarType(np.uint8))
  expectTrue(Int8.isCompatibleNumpyScalarType(np.int8))
  expectTrue(UInt16.isCompatibleNumpyScalarType(np.uint16))
  expectTrue(Int16.isCompatibleNumpyScalarType(np.int16))
  expectTrue(UInt32.isCompatibleNumpyScalarType(np.uint32))
  expectTrue(Int32.isCompatibleNumpyScalarType(np.int32))
  expectTrue(UInt64.isCompatibleNumpyScalarType(np.uint64))
  expectTrue(Int64.isCompatibleNumpyScalarType(np.int64))
  expectTrue(Float.isCompatibleNumpyScalarType(np.float32))
  expectTrue(Float.isCompatibleNumpyScalarType(np.single))
  expectTrue(Double.isCompatibleNumpyScalarType(np.float64))
  expectTrue(Double.isCompatibleNumpyScalarType(np.double))
}
